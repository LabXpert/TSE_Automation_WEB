...
import machineMaintenanceRoutes from './routes/machineMaintenance.route';
import maintenanceOrgRoutes from './routes/maintenanceOrg.route';
...
      'GET /api/machines/maintenance-expiring',
      'GET /api/machines/maintenance-stats',
      'GET /api/machines/by-maint-org/:orgId',
...
      'GET /api/maintenance-orgs',
      'POST /api/maintenance-orgs',
...
app.use('/api/maintenance-orgs', maintenanceOrgRoutes);
app.use('/api/machines', machineRoutes);
app.use('/api/machine-calibrations', machineCalibrationRoutes);
app.use('/api/machine-maintenances', machineMaintenanceRoutes);
