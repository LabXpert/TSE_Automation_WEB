...
function SidebarComponent() {
  ...
  const kayitIslemleriSayfalar = [
    '/personel-ekle',
    '/kullanici-ekle',
    '/deney-turu-ekle',
    '/makine-ekle',
    '/kalibrasyon-kurulus-ekle',
    '/bakim-kurulus-ekle'
  ];
  const kayitIslemleriAktif = kayitIslemleriSayfalar.includes(location.pathname);

  // Kayıt İşlemleri alt menüsü, ilgili sayfalardayken otomatik açık olsun
  useEffect(() => {
    if (kayitIslemleriAktif) {
      setKayitIslemleriAcik(true);
    }
  }, [kayitIslemleriAktif]);
                    ...
                    >
                      <div style={{ 
                        ...
                        <span style={{ 
                          ...
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M2,12A10,10 0 0,1 12,2C13.85,2 15.55,2.5 17,3.35L15.6,4.75C14.5,4.26 13.28,4 12,4A8,8 0 0,0 4,12C4,13.28 4.26,14.5 4.75,15.6L3.35,17C2.5,15.55 2,13.85 2,12M7,12A5,5 0 0,1 12,7C12.69,7 13.35,7.12 13.96,7.34L12.5,8.8C12.34,8.76 12.17,8.74 12,8.74A3.26,3.26 0 0,0 8.74,12C8.74,12.17 8.76,12.34 8.8,12.5L7.34,13.96C7.12,13.35 7,12.69 7,12M12,22A10,10 0 0,1 2,12C2,10.15 2.5,8.45 3.35,7L4.75,8.4C4.26,9.5 4,10.72 4,12A8,8 0 0,0 12,20C13.28,20 14.5,19.74 15.6,19.25L17,20.65C15.55,21.5 13.85,22 12,22Z"/>
                          </svg>
                        </span>
                        <span style={{ 
                          letterSpacing: '-0.01em',
