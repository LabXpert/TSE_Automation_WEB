...
import type { BakimKurulusu } from '../../models/Makine.tsx';
...
interface BakimKurulusEkleViewProps {
  kuruluslar: BakimKurulusu[];
  formData: BakimKurulusInput;
  loading: boolean;
  error: string;
  success: string;
  editingKuruluş: BakimKurulusu | null;
  searchTerm: string;
  currentPage: number;
  totalPages: number;
  onSubmit: (e: React.FormEvent) => void;
  onInputChange: (field: keyof BakimKurulusInput, value: string) => void;
  onEdit: (kuruluş: BakimKurulusu) => void;
...
const BakimKurulusEkleView: React.FC<BakimKurulusEkleViewProps> = ({
  kuruluslar,
  formData,
  loading,
  error,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          {editingKuruluş ? 'Bakım Kuruluşu Düzenle' : 'Yeni Bakım Kuruluşu Ekle'}
        </h1>
        <p style={{
          color: '#64748b',
          fontSize: '16px',
          ...
          {editingKuruluş ? 'Mevcut kuruluş bilgilerini güncelleyin' : 'Bakım hizmeti veren kuruluş bilgilerini girin'}
        </p>
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <p style={{ 
              ...
              {editingKuruluş ? 'Kuruluş bilgilerini güncelleyin' : 'Yeni bakım kuruluşu için gerekli bilgileri girin'}
            </p>
          </div>
          ...
          <form onSubmit={onSubmit} style={{ 
            ...
            className="form-scrollbar">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="Örn: TSE Bakım Laboratuvarı"
          ...
          {kuruluslar.length === 0 ? (
            <div style={{
              ...
              <div style={{ fontSize: '18px', marginBottom: '8px', color: '#374151' }}>
                Henüz bakim kuruluşu kaydı bulunmuyor
              </div>
...
export default BakimKurulusEkleView;